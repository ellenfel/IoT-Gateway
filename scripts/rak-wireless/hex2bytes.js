// Define the functions lppDecode, Decode, and decodeUplink

function lppDecode(bytes) {

	var sensor_types = {
        31: { 'size': 2, 'name': 'custom_sensor', 'signed': false, 'divisor': 1 },  // Example values
        26: { 'size': 2, 'name': 'custom_sensor', 'signed': false, 'divisor': 1 },  // Example values
...
function Decode(fPort, bytes, variables) {
    ...
    console.log('Bytes from the payload: ', bytes);

    // Decode the bytes and process them as before
...
let input = {
    fPort: 2,
    bytes: Buffer.from("ac1f09fffe1877f1", "hex"),
    variables: {}
};

// Call the decodeUplink function with the input
